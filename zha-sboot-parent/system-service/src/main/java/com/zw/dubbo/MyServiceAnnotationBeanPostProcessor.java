 ...
 */
public class MyServiceAnnotationBeanPostProcessor implements BeanDefinitionRegistryPostProcessor, EnvironmentAware,
    ...
    public MyServiceAnnotationBeanPostProcessor(String... packagesToScan) {
        this(Arrays.asList(packagesToScan));
    }

    public MyServiceAnnotationBeanPostProcessor(Collection<String> packagesToScan) {
        this(new LinkedHashSet<String>(packagesToScan));
    }

    public MyServiceAnnotationBeanPostProcessor(Set<String> packagesToScan) {
    ...
    private BeanNameGenerator resolveBeanNameGenerator(BeanDefinitionRegistry registry) {
        ...
        if (beanNameGenerator == null) {
            ...
            beanNameGenerator = new MyAnnotationBeanNameGenerator();
